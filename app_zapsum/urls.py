...
urlpatterns = patterns('app_zapsum',
    ...
    url(r'^diary/(?P<id_author>[0-9]*)/$', 'views.diary', name='diary'),
    url(r'^record/(?P<id_record>[0-9]*)/$', 'views.record', name='record'),
    url(r'^profile/(?P<id_author>[0-9]*)/$', 'views.profile', name='profile'),
